...
import model.vo.XxsshrJmrFormVOImpl;
...
//
    ...
    public void filterUser() {
        ...
        ViewObjectImpl vo = getXxsshrJmrFormVO();
        vo.setNamedWhereClauseParam("b_username", userName);
        System.out.println("get Query ----------- " + vo.getQuery());
        vo.executeQuery();      
    ...
    /**
     * Container's getter for XxsshrJmrFormVO1.
     * @return XxsshrJmrFormVO1
     */
    public XxsshrJmrFormVOImpl getXxsshrJmrFormVO() {
        return (XxsshrJmrFormVOImpl) findViewObject("XxsshrJmrFormVO");
    }

    /**
     * Container's getter for LookUpValues_ROVO1.
     * @return LookUpValues_ROVO1
     */
    public ViewObjectImpl getLookUpValues_ROVO() {
        return (ViewObjectImpl) findViewObject("LookUpValues_ROVO");
    }

    /**
     * Container's getter for NominatorEmployee_ROVO1.
     * @return NominatorEmployee_ROVO1
     */
    public ViewObjectImpl getNominatorEmployee_ROVO() {
        return (ViewObjectImpl) findViewObject("NominatorEmployee_ROVO");
    }

    /**
     * Container's getter for MobilityDeptManagers_ROVO1.
     * @return MobilityDeptManagers_ROVO1
     */
    public ViewObjectImpl getMobilityDeptManagers_ROVO() {
        return (ViewObjectImpl) findViewObject("MobilityDeptManagers_ROVO");
    }
     ...
     * @return XxsshrJmrFormVO1
     */
    public XxsshrJmrFormVOImpl getXxsshrJmrFormVO1() {
        return (XxsshrJmrFormVOImpl) findViewObject("XxsshrJmrFormVO1");
    }
}
